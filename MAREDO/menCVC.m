...
static NSString * const reuseIdentifier = @"manCell";
...
//    [settingsButton setTitleTextAttributes:fontDictionary forState:UIControlStateNormal];
    ...
    menShoesImages = [NSArray arrayWithObjects: @"cimage2", @"cimage3", @"cimage5", @"cimage10",  @"cimage12", @"cimage13", @"cimage14", @"cimage16", @"cimage17", @"cimage2", nil];
    ...
    self.menShoes = [NSArray arrayWithObjects:shoe2,shoe3,shoe5,shoe10,shoe12,shoe13,shoe14,shoe16,shoe17,shoe18,nil];
}
